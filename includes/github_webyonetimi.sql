...
CREATE TABLE IF NOT EXISTS `veritabanlari` (
  ...
  `islem` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_turkish_ci DEFAULT NULL,
  `islemi_yapan` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_turkish_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `database_name` (`db_name`),
  UNIQUE KEY `website_name` (`website_name`)
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_turkish_ci;
...
CREATE TABLE IF NOT EXISTS `zamanlanmisgorev` (
  ...
  `uzak_sunucu_korunacak_yedek` int NOT NULL DEFAULT '-1',
